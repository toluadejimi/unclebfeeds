...
<body style="">
    ...
    <div class="container">
            ...
            <div class="form-row">
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <select class="form-control" required name="name">
                        ...
                        <option value="cm">Chick Mash Formation</option>
                        <option value="gm">Grower's Mash Formation</option>
                        <option value="lm">Layer's Mash Formation</option>
                        <option value="bs">Broiler's Stater Formation</option>
                        <option value="bf">Broiler's Finisher Formation</option>
                        <option value="pr">Pre Layer's Mesh Formation</option>
                    </select>
                ...
                <div class="col-md-3 mb-3">
                    <select class="form-control" required name="ton">
                        ...
                        <option value="15">1.5 TONS</option>
        ...
        @if($formation_title == null)

        <p class="my-5">Choose Formation and Ton to get formation</p>
        <p>{{ $formation_note  ?? null }}</p>


        @else

        <h5 class="my-5">{{ $formation->title ?? "Formation Name" }}</h5>

        <div style="height:600px; width:100%; overflow-y: scroll;">

            <form action="/update-formation" method="POST">
                @csrf
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-2 mb-3">
                        <input type="number" class="form-control" step="any" name="maize" value="{{ $formation->maize }}" </div>
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-2 mb-3">
                        <input type="number" class="form-control" step="any" name="soya" value="{{ $formation->soya }}" </div>
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-1 mb-3">
                        <input type="number" class="form-control" step="any" name="weathofful" value="{{ $formation->weathofful }}"
                            </div>
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-2 mb-3">
                        <input type="number" class="form-control" step="any" name="bonemeal" value="{{ $formation->bonemeal }}"
                            </div>
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-2 mb-3">
                        <input type="number" class="form-control" step="any" name="limestone" value="{{ $formation->limestone }}"
                            </div>
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-2 mb-3">
                        <input type="number" class="form-control" step="any" name="salt" value="{{ $formation->salt }}" </div>
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-2 mb-3">
                        <input type="number" class="form-control" step="any" name="lysine" value="{{ $formation->lysine }}" </div>
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-2 mb-3">
                        <input type="number" class="form-control" step="any" name="methionine" value="{{ $formation->methionine }}"
                            </div>
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-2 mb-3">
                        <input type="number" class="form-control" step="any" name="fulzyme" value="{{ $formation->fulzyme }}"
                            </div>
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-2 mb-3">
                        <input type="number" class="form-control" step="any" name="zerotox" value="{{ $formation->zerotox }}"
                            </div>
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-2 mb-3">
                        <input type="number" class="form-control" step="any" name="gprmix" value="{{ $formation->gprmix }}"
                            </div>
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-2 mb-3">
                        <input type="number" class="form-control" step="any" name="lprmix" value="{{ $formation->lprmix }}"
