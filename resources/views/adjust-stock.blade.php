...
<body style="">
    ...
    <div class="container">
        ...
        <h5 class="my-5">Final Prdocution Stocks</h5>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><button type="button" data-toggle="modal" data-target="#register{{  $item->id }}"
                        ...
                        <div class="modal fade" id="register{{  $item->id }}" tabindex="-1" role="dialog"
                            aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">

                                    <div class="modal-body">
                                        <h5 class="my-3">Adjust Sctock</h5>

                                        <form action="/add-to-stock" method="POST">
                                            @csrf

                                            <h6 class="my-3">{{ $item->name }} | {{ $item->qty }} Bags</h6>
                                            ...
                                            <div class="my-2">
                                                <button class="btn btn-success" required type="submit" autofocus> Adjust
                                                    Stock</button>
                                            </div>
        ...
        <h5 class="my-3">Materials history</h5>
